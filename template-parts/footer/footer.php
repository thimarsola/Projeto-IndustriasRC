            ...
            <div class="footer__developer__row d-flex jc-between ai-center clr-white-500">
                ...
                <?php if (!is_404()) : ?>
                    <div class="footer__developer__row__validator">
                        <p>
                            <small>
                                <a rel="nofollow noreferrer noopener" class="d-flex jc-center ai-center link-white-500" href="https://validator.w3.org/nu/?doc=<?php echo get_current_page_url(); ?>" target="_blank" title="Tecnologia W3C">
                                    <i class="icon-html"></i>
                                    W3C Validator
                                </a>
                            </small>
