              ...
              <article class="products__row__card bg-white-500 shadow">
                  ...
                  <!-- body -->
                   <div class="products__row__card__body t-center">
                       ...
                       <a class="btn btn-primary-500 radius" href="<?= get_the_permalink(get_page_by_title($product['title'])); ?>" title="Conheça a essa nossa linha de produto" target="_blank">Saiba mais</a>
                   </div>
                  <!-- end of body -->
              </article>
             <!-- end of card -->
