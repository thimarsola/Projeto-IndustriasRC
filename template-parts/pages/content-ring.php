...
<div class="content__row__container__row grid mt-6">
    <!-- card -->
     <article class="content__row__container__row__card bg-white-500 f-column shadow">
         ...
         <header class="content__row__container__row__card__header mt-3 mb-2 t-center">
             <h3><?= get_the_title(get_page_by_title('Anéis de Retenção')); ?></h3>
         </header>
         <!-- end of header -->
    ...
    <!-- card -->
     <article class="content__row__container__row__card bg-white-500 f-column shadow">
         ...
         <!-- header -->
         <header class="content__row__container__row__card__header mt-3 mb-2 t-center">
             <h3><?= get_the_title(get_page_by_title('Anéis de Travamento')); ?></h3>
         </header>
         <!-- end of header -->
    ...
    <!-- card -->
     <article class="content__row__container__row__card bg-white-500 f-column shadow">
         ...
         <!-- header -->
         <header class="content__row__container__row__card__header mt-3 mb-2 t-center">
             <h3><?= get_the_title(get_page_by_title('Pinos Elásticos')); ?></h3>
         </header>
         <!-- end of header -->
